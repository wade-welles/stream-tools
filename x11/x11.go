...
//		Client:                conn,
//		ActiveWindowTitle:     "",
//		ActiveWindowChangedAt: time.Now(),
//	}
//
//	//x11Conn.ActiveWindowTitle = x11Conn.ActiveWindow().Title
//	//if len(x11Conn.ActiveWindowTitle) != 0 {
//	//	x11Conn.ActiveWindowChangedAt = time.Now()
//
//	//}
//
//	//fmt.Printf("activeWindow: %v\n", x11Conn.ActiveWindow())
//
//	//return x11Conn
//}
